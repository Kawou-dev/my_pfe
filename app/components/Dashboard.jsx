...
const Dashboard = () => {
  ...
  const getTimeLeft = (deadline) => {
    ...
    return `${days}j ${hours}h ${minutes}min `;
      ...
      const {fetchVacance , vacances, fetchFavoriVacance , favorisVac , loading} = useVacance()  ; 
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <button className="aspect-square border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-50">
                    ...
                    {/* <div class="flex items-center justify-center h-screen bg-white">
                        <div class="animate-spin rounded-full h-8 w-16 border-4 border-gray-300 border-t-transparent"></div>
                      </div> */}
              ...
              <div>
                <h3 className="font-semibold text-gray-700 mb-2">Nous posez des questions ?</h3>
                <textarea value={feedfeedback.content}   onChange={(e) => setFeedback({...feedfeedback , content : e.target.value})}
                  placeholder="Décrivez votre soucis..."
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  rows={3}
                />
                <div className="flex justify-end mt-2 space-x-2">
                  <button onClick={handleSendTicket}
                   className="flex items-center bg-green-100 text-green-700 px-3 py-1 rounded-lg cursor-pointer ">
                    {/* <FiShare2 className="mr-1" /> Partager */}
